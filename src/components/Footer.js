...
const Footer = () => {
  return (
    <footer className="bg-gray-900 mt-16 py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="text-gray-400">
            Transforming digital content creation with advanced AI and Web3 technologies.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            ...
            <li><Link to="/create" className="hover:text-purple-400">Create NFT</Link></li>
      ...
      <div className="container mx-auto border-t border-gray-800 mt-8 pt-8 text-gray-400 text-sm">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p>© 2025 Athena3D. All rights reserved.</p>
